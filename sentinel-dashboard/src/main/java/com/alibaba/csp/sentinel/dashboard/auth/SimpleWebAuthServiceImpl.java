...
@Primary
@Component
@ConditionalOnProperty(value = "sentinel.auth-filter.enable", matchIfMissing = true)
public class SimpleWebAuthServiceImpl implements AuthService<HttpServletRequest> {
	...
	public AuthUser getAuthUser(HttpServletRequest request) {
		...
		Object sentinelUserObj = session
				.getAttribute(SimpleWebAuthServiceImpl.WEB_SESSTION_KEY);
